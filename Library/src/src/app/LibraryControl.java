...
import src.data.Book;
import src.data.Library;
import src.data.LibraryUser;
import src.data.Magazine;
import src.utils.DataReader;
import src.utils.FileManager;
import src.utils.LibraryUtils;  
...
public class LibraryControl {
    ...
    public LibraryControl() {
        ...
        try {
            library = fileManager.readLibraryFile();
    ...
    private void addMagazine() {
        Magazine magazine = dataReader.readAndCreatMagazine();
